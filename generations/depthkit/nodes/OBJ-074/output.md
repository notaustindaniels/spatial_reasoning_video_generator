 ...
 * - 5 scenes x 12 seconds each (start_times: 0, 12, 24, 36, 48)
 ...
 *  Geometry: stage (6 planes) x 5 scenes
 ...
 * "WARNING: Hardware mode fell back to SwiftShader -- comparison
 *  is not GPU vs CPU."
 */
...
- 5 scenes x 12 seconds = 60 seconds exactly, matching C-08.
...
26. **Frame jitter analysis:** Inspect `timing.stddevFrameMs` and `timing.p99FrameMs`. If p99 > 2x average, investigate throttling or GC causes. This is a diagnostic observation, not a pass/fail criterion.
